...
public class GenerateModifiedFileClosureLinter {
	
	private static String SOURCE = "projects";
	private static String DESTINATION = "modified_projects/closure_linter";
	...
	{
		GenerateModifiedFileClosureLinter	main = new GenerateModifiedFileClosureLinter();
		main.run();
		System.exit(0);
	}
}