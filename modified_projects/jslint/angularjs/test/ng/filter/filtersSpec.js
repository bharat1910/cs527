...
describe('filters', function() {
  ...
  describe('number', function() {
    ...
    it('should do basic filter', function() {
      ...
      expect(number(0.1,       2)).toEqual("0.10");
      expect(number(0.01,      2)).toEqual("0.01");
      expect(number(0.001,     3)).toEqual("0.001");
      expect(number(0.0001,    3)).toEqual("0.000");
      expect(number(9,        2)).toEqual("9.00");
      expect(number(0.9,       2)).toEqual("0.90");
      expect(number(0.99,      2)).toEqual("0.99");
      expect(number(0.999,     3)).toEqual("0.999");
      expect(number(0.9999,    3)).toEqual("1.000");
